 ...
 *
 * @link       https://github.com/zachwatkins/template-genesis-theme/blob/master/src/Genesis.php
 * @since      0.1.0
 * @package    template-genesis-theme
 * @subpackage template-genesis-theme/genesis
 */

namespace Template_Genesis_Theme;
...
class Genesis
{
    ...
    public function __construct()
    {
        ...
        add_action("wp", [$this, "archive_customizations"]);

        // Implement Google Search if the site has an id in the theme option field.
        add_action(
            "genesis_before_loop",
            [$this, "add_google_cse_results"],
            11,
        );
        add_filter("genesis_noposts_text", [
            $this,
            "empty_google_cse_results_text",
        ]);
        add_action("pre_get_posts", [$this, "empty_wp_results_for_google_cse"]);
    }
